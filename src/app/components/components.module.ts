...
import {MultiMediaCarousel} from "./media-ee-carousel/media.ee.carousel.component";
...
const COMPONENTS = [
  ...
  NavbarComponent, NavbarSubMenuComponent, MediaCarouselComponent,MultiMediaCarousel
];
